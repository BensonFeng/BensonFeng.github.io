  ...
  return (
    <div>
      <div className="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div className="flex flex-wrap md:flex-nowrap sm:flex=nonwrap">
          ...
          <Image
            ...
            height={450}
            width={550}
            className="w-3/4 mt-12 2xl:visible xl:visible lg:invisible md:invisible  md:absolute -mt-6 md:mt-0 right-0 -z-1  sm:visible"
          />
        </div>
      </div>
    </div>
